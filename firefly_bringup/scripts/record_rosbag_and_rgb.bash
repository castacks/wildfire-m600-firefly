...
# Run DJI SDK
# source /home/wildfire/mm600_ws/devel/setup.bash && nohup roslaunch dji_sdk sdk.launch &
sleep 4
...
# run Mavlink
#python3 ~/mm600_ws/src/data_collection/ros_mavlink_test.py &

# run thermal
# source /home/wildfire/mm600_ws/devel/setup.bash && roslaunch flir_ros_sync flir_ros.launch &
#source /home/wildfire/mm600_ws/devel/setup.bash && roslaunch flir_ros_sync flir_ros.launch &

#source /home/wildfire/mm600_ws/devel/setup.bash && roslaunch seek_driver seek_driver.launch &
