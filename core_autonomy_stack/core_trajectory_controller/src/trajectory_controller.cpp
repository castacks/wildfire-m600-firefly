...
private:
  ...
  ros::ServiceServer traj_style_srv, traj_mode_srv, traj_mode_get_srv;
...
public:
  ...
  bool get_trajectory_mode(core_trajectory_controller::TrajectoryMode::Request& req,
			   core_trajectory_controller::TrajectoryMode::Response& res);
...
bool TrajectoryControlNode::initialize(){
  ...
  traj_mode_get_srv = nh -> advertiseService("get_trajectory_mode", &TrajectoryControlNode::get_trajectory_mode, this);
...
bool TrajectoryControlNode::get_trajectory_mode(core_trajectory_controller::TrajectoryMode::Request& req, core_trajectory_controller::TrajectoryMode::Response& res) {
  res.mode = trajectory_mode;
  res.success = true;
  return true;
}
