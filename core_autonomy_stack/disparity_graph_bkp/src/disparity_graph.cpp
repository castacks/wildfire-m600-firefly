...
disparity_graph::disparity_graph() {
    ...
    graph_size = 10;
    angle_tol = /*cos*/(30.0);
    displacement_tol = 1.0;
    first = true;
    got_cam_info = false;
    fixed_frame = "world";
    stabilized_frame = "base_link_stabilized";
    ...
    disp_fg_sub_.subscribe(priv_nh,"left/disparity_expanded_fg",1);
    disp_bg_sub_.subscribe(priv_nh,"left/disparity_expanded_bg",1);
    ...
    //cam_info_sub_ = priv_nh.subscribe("/uav1/front_stereo/right/camera_info", 1,&disparity_graph::getCamInfo,this);
    cam_info_sub_ = priv_nh.subscribe("right/camera_info", 1,&disparity_graph::getCamInfo,this);
...
ROS_ERROR("PCDGRAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPH");
  pcl::PointXYZI pt;
