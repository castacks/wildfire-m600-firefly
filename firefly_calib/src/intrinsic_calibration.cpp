...
int main()
{
    ...
    std::string path = "/media/kevin/T7/images/*.jpg";
    ...
    for(int i{0}; i<images.size(); i++)
    {
        ...
        */
        if(success)
        {
            ...
            std::cout<<"Found corners in image : "<<images[i]<<std::endl;
    ...
    */
    ...
    double rmse = cv::calibrateCamera(objpoints, imgpoints, cv::Size(gray.rows,gray.cols), cameraMatrix, distCoeffs, R, T, cv::CALIB_FIX_K3);
